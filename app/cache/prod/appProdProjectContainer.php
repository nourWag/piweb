...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tunisamallha', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4a3db66c740eff14e1df00713e570fea8c8846cde53518ba203422f6b01421c5');
        return $instance;
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'Myapp\\ResponsableBundle\\MyBundle\\Entity\\Comment');
    }
    protected function getFosComment_Manager_Thread_DefaultService()
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('event_dispatcher'), $this->get('fos_comment.entity_manager'), 'Myapp\\ResponsableBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['kitpages_data_grid.grid_manager'] = new \Kitpages\DataGridBundle\Grid\GridManager($this->get('event_dispatcher'), $this->get('kitpages_data_grid.paginator_manager'), $this->get('kitpages_data_grid.item_list_normalizer.standard'), '\\Kitpages\\DataGridBundle\\Hydrators\\DataGridHydrator');
    }
    ...
    {
        return $this->services['kitpages_data_grid.paginator_manager'] = new \Kitpages\DataGridBundle\Paginator\PaginatorManager($this->get('event_dispatcher'), array('default_twig' => 'KitpagesDataGridBundle:Paginator:bootstrap3-paginator.html.twig', 'item_count_in_page' => 50, 'visible_page_count_in_paginator' => 5));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f->addHandler($this->get('security.logout.handler.session'));
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $this->get('redirect.after.login'), new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5738bed56e4c2', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/', false), '/error403', NULL, $b));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'MyappResponsableBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_00000000305718d700000000690b1e69(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_00000000305718e900000000690b1e69(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
...
class VichUploaderBundleHandlerDownloadHandler_00000000305718d700000000690b1e69 extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5738bedf78c45431195440 = null;
    private $initializer5738bedf79508925846736 = null;
    private static $publicProperties5738bedf75ae4620707915 = array(
        
    );
    public function downloadObject($object, $field, $className = null, $fileName = null)
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer5738bedf79508925846736);
        return $this->valueHolder5738bedf78c45431195440->downloadObject($object, $field, $className, $fileName);
    }
    public function __construct($initializer)
    {
        $this->initializer5738bedf79508925846736 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__get', array('name' => $name), $this->initializer5738bedf79508925846736);
        if (isset(self::$publicProperties5738bedf75ae4620707915[$name])) {
            return $this->valueHolder5738bedf78c45431195440->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedf78c45431195440;
    ...
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5738bedf79508925846736);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedf78c45431195440;
    ...
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__isset', array('name' => $name), $this->initializer5738bedf79508925846736);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedf78c45431195440;
    ...
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__unset', array('name' => $name), $this->initializer5738bedf79508925846736);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedf78c45431195440;
    ...
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__clone', array(), $this->initializer5738bedf79508925846736);
        $this->valueHolder5738bedf78c45431195440 = clone $this->valueHolder5738bedf78c45431195440;
    }
    public function __sleep()
    {
        $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, '__sleep', array(), $this->initializer5738bedf79508925846736);
        return array('valueHolder5738bedf78c45431195440');
    }
    ...
    {
        return $this->initializer5738bedf79508925846736;
    }
    public function initializeProxy()
    {
        return $this->initializer5738bedf79508925846736 && $this->initializer5738bedf79508925846736->__invoke($this->valueHolder5738bedf78c45431195440, $this, 'initializeProxy', array(), $this->initializer5738bedf79508925846736);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5738bedf78c45431195440;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5738bedf78c45431195440;
    }
}
class VichUploaderBundleHandlerUploadHandler_00000000305718e900000000690b1e69 extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5738bedfaa6ea678479522 = null;
    private $initializer5738bedfaa919895236612 = null;
    private static $publicProperties5738bedfaa376952803560 = array(
        
    );
    public function upload($obj, $fieldName)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738bedfaa919895236612);
        return $this->valueHolder5738bedfaa6ea678479522->upload($obj, $fieldName);
    }
    public function inject($obj, $fieldName)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738bedfaa919895236612);
        return $this->valueHolder5738bedfaa6ea678479522->inject($obj, $fieldName);
    }
    public function clean($obj, $fieldName)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738bedfaa919895236612);
        return $this->valueHolder5738bedfaa6ea678479522->clean($obj, $fieldName);
    }
    public function remove($obj, $fieldName)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738bedfaa919895236612);
        return $this->valueHolder5738bedfaa6ea678479522->remove($obj, $fieldName);
    }
    public function __construct($initializer)
    {
        $this->initializer5738bedfaa919895236612 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__get', array('name' => $name), $this->initializer5738bedfaa919895236612);
        if (isset(self::$publicProperties5738bedfaa376952803560[$name])) {
            return $this->valueHolder5738bedfaa6ea678479522->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedfaa6ea678479522;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5738bedfaa919895236612);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedfaa6ea678479522;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__isset', array('name' => $name), $this->initializer5738bedfaa919895236612);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedfaa6ea678479522;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__unset', array('name' => $name), $this->initializer5738bedfaa919895236612);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738bedfaa6ea678479522;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__clone', array(), $this->initializer5738bedfaa919895236612);
        $this->valueHolder5738bedfaa6ea678479522 = clone $this->valueHolder5738bedfaa6ea678479522;
    }
    public function __sleep()
    {
        $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, '__sleep', array(), $this->initializer5738bedfaa919895236612);
        return array('valueHolder5738bedfaa6ea678479522');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5738bedfaa919895236612;
    }
    public function initializeProxy()
    {
        return $this->initializer5738bedfaa919895236612 && $this->initializer5738bedfaa919895236612->__invoke($this->valueHolder5738bedfaa6ea678479522, $this, 'initializeProxy', array(), $this->initializer5738bedfaa919895236612);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5738bedfaa6ea678479522;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5738bedfaa6ea678479522;
    }
}
