 ...
 */
class Mail extends \Myapp\ResponsableBundle\Entity\Mail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'id', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'nom', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'prenom', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'tel', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'from', '' . "\0" . 'Myapp\\ResponsableBundle\\Entity\\Mail' . "\0" . 'text'];
        }
