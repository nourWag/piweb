 ...
 */
class Pages extends \Myapp\adminBundle\Entity\Pages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Myapp\\adminBundle\\Entity\\Pages' . "\0" . 'id', '' . "\0" . 'Myapp\\adminBundle\\Entity\\Pages' . "\0" . 'titre', '' . "\0" . 'Myapp\\adminBundle\\Entity\\Pages' . "\0" . 'contenu'];
        }
