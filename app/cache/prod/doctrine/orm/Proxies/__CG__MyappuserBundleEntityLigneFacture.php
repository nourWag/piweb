 ...
 */
class LigneFacture extends \Myapp\userBundle\Entity\LigneFacture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Myapp\\userBundle\\Entity\\LigneFacture' . "\0" . 'facture', '' . "\0" . 'Myapp\\userBundle\\Entity\\LigneFacture' . "\0" . 'idPr', '' . "\0" . 'Myapp\\userBundle\\Entity\\LigneFacture' . "\0" . 'quantite'];
        }
    ...
    public function getIdPr()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdPr();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdPr', []);

        return parent::getIdPr();
    }
    ...
    public function setIdPr($idPr)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdPr', [$idPr]);

        return parent::setIdPr($idPr);
    }
