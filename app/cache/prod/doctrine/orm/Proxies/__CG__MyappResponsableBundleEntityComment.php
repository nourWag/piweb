 ...
 */
class Comment extends \Myapp\ResponsableBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'thread', 'ancestors', 'parent', 'body', 'depth', 'createdAt', 'state', 'previousState'];
        }
