    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if ($pathinfo === '/admin/logout') {
                return array (  '_controller' => 'MyappadminBundle:Security:logout',  '_route' => 'logout',);
            }
            ...
            // affpack
            if ($pathinfo === '/admin/affipack') {
                return array (  '_controller' => 'Myapp\\adminBundle\\Controller\\ImageController::listAction',  '_route' => 'affpack',);
            }

            // suprimerpack
            if (0 === strpos($pathinfo, '/admin/supprimer') && preg_match('#^/admin/supprimer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'suprimerpack')), array (  '_controller' => 'Myapp\\adminBundle\\Controller\\ImageController::supprimerAction',));
            }

            // editpack
            if (0 === strpos($pathinfo, '/admin/modifier') && preg_match('#^/admin/modifier/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'editpack')), array (  '_controller' => 'Myapp\\adminBundle\\Controller\\ImageController::ModifierAction',));
            }
