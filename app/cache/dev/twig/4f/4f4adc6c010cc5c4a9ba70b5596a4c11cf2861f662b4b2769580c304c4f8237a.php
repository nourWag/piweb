...
class __TwigTemplate_f5f3766d9b3411acde99b9923cc5c59583f4cac19e95cbcdbda611be49a6b2d6 extends Twig_Template
{
  ...
  <body class=\"hold-transition skin-blue sidebar-mini\">
    <div class=\"wrapper\">
      ...
      <aside class=\"main-sidebar\">
        ...
        echo "\">
<i class=\"fa fa-circle-o\"></i> afficher liste de client</a></li>
                <li><a href= \"";
        // line 329
        echo $this->env->getExtension('routing')->getPath("rech");
        echo "\"><i class=\"fa fa-circle-o\"></i>  rechercher client </a></li>
              </ul>
            </li>
            <li class=\"treeview\">
              <a href=\"#\">
...
/*               </a>*/
/*               <ul class="treeview-menu">*/
/*                 <li class="active"><a href="{{ path('affich') }}">*/
/* <i class="fa fa-circle-o"></i> afficher liste de client</a></li>*/
/*                 <li><a href= "{{ path('rech') }}"><i class="fa fa-circle-o"></i>  rechercher client </a></li>*/
/*               </ul>*/
/*             </li>*/
/*             <li class="treeview">*/
/*               <a href="#">*/
...
/*             <li><a href="documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>*/
/*             <li class="header">paramétres</li>*/
/*             <li><a href="{{ path('changePassword') }}"><i class="fa fa-circle-o text-red"></i> <span>change password</span></a></li>*/
/*             <li><a href="{{ path('edit') }}"><i class="fa fa-circle-o text-yellow"></i> <span>editer infomation</span></a></li>*/
/*             <li><a href="{{ path('profile') }}"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li>*/
/*           </ul>*/
/*         </section>*/
/*         <!-- /.sidebar -->*/
/*       </aside>*/
