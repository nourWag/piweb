...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class=field_"<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          <legend><?php echo $text_your_details; ?></legend>
              ...
              <div id="results" <?php if (count($customer_groups)>1){?>style="display:block"<?php } else {?>style="display:none"<?php }?>>
