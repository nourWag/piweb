...
use Myapp\ResponsableBundle\useBundle\Entity\packet;
use Myapp\ResponsableBundle\useBundle\Form\packetType;
...
class packetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyappResponsableBundle:packet')->findAll();

        return $this->render('MyappResponsableBundle:packet:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MyappResponsableBundle:packet:new.html.twig', array(
            'entity' => $entity,
        ...
        function listAction()
{
   ...
   $model=$em->getRepository
    ...
    return $this->render
 ('MyappResponsableBundle:packet:affichage.html.twig',array('mod'=>$model));
}
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyappResponsableBundle:packet')->find($id);
        ...
        return $this->render('MyappResponsableBundle:packet:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MyappResponsableBundle:packet:edit.html.twig', array(
            'entity'      => $entity,
